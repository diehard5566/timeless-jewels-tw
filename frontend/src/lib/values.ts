/**
 * 已廢止：勿再以 GGG Stats._key（數字）當穩定 ID，改版後會錯義。
 * 繁中改由 stat-id-chinese.json / WASM StatIdToChineseJSON（stat.Id 字串）提供。
 * 此表僅保留 translateStat 最後手段，應維持空物件。
 */
...
/** 搜尋結果列表配色用權重；僅收錄目前 PossibleStats 會出現的 _key */
